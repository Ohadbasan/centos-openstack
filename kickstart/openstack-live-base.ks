...
#repo --name=optional  --baseurl=http://download.eng.tlv.redhat.com/pub/rhel/rel-eng/latest-RHEL-6/6.4/Server/optional/x86_64/os
#repo --name=epel      --mirrorlist=http://mirrors.fedoraproject.org/metalink?repo=epel-6&arch=$basearch
#repo --name=rhos      --baseurl=http://download.lab.bos.redhat.com/rel-eng/OpenStack/Folsom/latest/x86_64/os/

xconfig --startxonboot
services --enabled=NetworkManager,httpd,sshd --disabled=network
